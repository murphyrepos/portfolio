...
const PortfolioDetailOverview = ({
  ...
  return (
    <Link
      className='border-1 group mx-auto flex w-[90%] items-center justify-center gap-5 rounded-3xl border-neutral-100 bg-neutral-100 px-4 py-4 md:max-w-[900px] shadow-lg shadow-neutral-200'
      href={url}
    >
