  ...
  return (
    ...
    >
      <div className='flex w-full flex-1 flex-col items-center justify-center gap-6 bg-neutral-100 shadow-neutral-100 sm:flex-row'>
        <DotLottieReact src={logo} autoplay loop />
        ...
        <div className='flex min-h-7 min-w-7 flex-col items-center justify-center rounded-full border border-primary bg-[#FAFAFA] transition-all delay-150 duration-300 group-hover:animate-bounce md:min-h-10 md:min-w-10'>
