...
const HeroSection = () => {
  ...
  return (
    <Container className='max-w-none min-w-full bg-linear-to-br from-blue-100 via-white to-gray-50 py-16'>
      <motion.section
        ref={heroRef}
        style={{ opacity, scale }}
        className='relative flex min-h-screen items-center'
      >
        <Container className='relative z-10 mx-auto flex max-w-7xl flex-col-reverse items-center gap-12 px-6 py-20 md:grid lg:grid-cols-2 lg:px-12'>
          <motion.div
          ...
          <motion.div
            ...
            className='relative'
          >
            <div className='h-105 overflow-hidden rounded-4xl md:h-155'>
              <DotLottieReact
